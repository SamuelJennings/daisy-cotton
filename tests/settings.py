"""Django settings for testing daisy-cotton."""

from pathlib import Path

BASE_DIR = Path(__file__).resolve().parent.parent

SECRET_KEY = "django-insecure-test-key-for-daisy-cotton-tests-only"
...
# The demo's URLconf, so its pages are reachable from the suite.
