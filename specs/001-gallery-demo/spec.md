...
- **FR-009**: The defect MUST be recorded, with its reproduction and the affected links, in an issue in this repository during implementation. That issue is what the skipped cases name. *(US2)*
